...
const team = [
  {
    ...
    description: "Более 7 лет являюсь ментором. Специализируюсь на индивидуальном подходе и создании уникальных образовательных программ. Главная цель — помочь каждому ученику достичь успеха.",
    image: "/public/placeholder.svg",
  },
  {
    name: "Мухаммад Сафарбеков",
    role: "Эксперт английского языка",
    description: "Специалист по подготовке к TOEFL и IELTS. Помогаю студентам достичь высоких баллов за короткий срок.",
    image: "/",
  },
  {
    name: "МухаммадФируз",
    role: "Эксперт по SAT",
    description: "Эксперт в математике и SAT. Помогаю освоить сложные термины и легко справляться с экзаменационными задачами.",
    image: "/",
  },
];
